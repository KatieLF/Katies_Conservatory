...
I've managed to set up an [Immich](https://github.com/immich-app/immich) instance on my families' NAS and connect it to my phone. v2.7.5 doesn't have great multi-user support so I'm waiting on sharing it with my family until v3.0.0 drops later this year. Combined with the Jellyfin, it is using 75% of the 8gb of ram that it has so I'll have to deal with that in the future.
